...
const PersonLogo = require('../images/icon-person.svg') as string;
const DollarLogo = require('../images/icon-dollar.svg') as string;
...
const Calculator:React.FC<CalculatorProps> = ({ form }) => (
  <div id="calculator">
    ...
    >
      <Input
        prefix={<img alt="person" src={DollarLogo} />}
        placeholder="0"
        type="number"
      />
    </Form.Item>
        ...
        <Radio.Button value={-1} className="custom-tip">
          ...
          >
            <Input
              placeholder="Custom"
              type="number"
              onClick={() => form.setFieldsValue({ tipPercent: -1 })}
            />
          </Form.Item>
        </Radio.Button>
      </Radio.Group>
    ...
    >
      <Input
        prefix={<img alt="person" src={PersonLogo} />}
        placeholder="0"
        type="number"
        min="0"
        step="1"
